...
finish:
  ...
  mov r11, rax                ; syscall address
  mov r10, rcx                ; Syscall stuff
  mov rax, dword [r11 + 4]    ; copy the syscall number to rax
  lea r11, [r11 + 8]          ; point to the syscall instruction
  jmp r11                     ; Jump into the required function
